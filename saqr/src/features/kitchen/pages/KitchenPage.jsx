      ...
      <div className="row g-0">
        <div className="col-12 col-lg-3 pe-lg-4 mb-4">
          <div className="d-flex flex-column gap-2 sticky-top pt-2" style={{ top: '20px' }}>
            ...
            <div className="mt-5 p-4 rounded-4 border border-gold border-opacity-10 bg-dark bg-opacity-40">
              <h6 className="text-gold fw-bold mb-3 small d-flex align-items-center gap-2">
                <ShieldCheck size={14} /> حالة المنظومة
              </h6>
              <div className="d-flex align-items-center gap-2 mb-2">
                <div
                  className={healthData.api === 'Connected' ? 'pulse-led-green' : 'pulse-led-ruby'}
                ></div>
                <span className="small text-secondary">
                  الربط مع المنصة: {healthData.api === 'Connected' ? 'متصل' : 'غير متصل'}
                </span>
              </div>
              <div className="d-flex align-items-center gap-2 mb-2">
                <div className="pulse-led-green"></div>
                <span className="small text-secondary">نوع المنظومة: حقيقية (Live)</span>
              </div>
              <div className="d-flex align-items-center gap-2">
                <div className="pulse-led-green"></div>
                <span className="small text-secondary">قواعد الصقر: فعّالة</span>
              </div>
            </div>
          </div>
        </div>
